...
ffmpeg -y -i farador.mp4 -c:a copy -ac 2 -ab 128k -c:v libx264 -x264opts 'keyint=30:min-keyint=30:no-scenecut' -b:v 1500k -maxrate 1500k -bufsize 1000k -vf scale=960:720,setdar=4/3 farador-refactored.mp4
