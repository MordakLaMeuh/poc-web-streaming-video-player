...
ffmpeg -y -i farador-tmp_1.mp4 -ar 48000 -c:a libopus -ac 2 -ab 128k -c:v libx264 -x264opts 'keyint=60:min-keyint=60:no-scenecut' -b:v 1500k -maxrate 1500k -bufsize 1000k -vf scale=960:720,setdar=4/3 farador-refactored.mp4
