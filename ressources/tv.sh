...
ffmpeg -y -i tv-tmp_1.mp4 -c:a copy -ac 2 -ab 128k -c:v libx264 -x264opts 'keyint=60:min-keyint=60:no-scenecut' -b:v 1500k -maxrate 1500k -bufsize 1000k -vf scale=960:720,setdar=4/3 tv-refactored.mp4
rm -v tv-tmp_1.mp4
